...
3. `cigar-canon = 0.9.1-honey.1`
4. `cigar-protocol = 0.9.1-honey.1`
5. `cigar-testkit = 0.9.1-honey.1`
6. `cigar-windows-ipc = 0.9.1-honey.1`
7. `cigar-crypto = 0.9.1-honey.1`
8. `cigar-replay = 0.9.1-honey.1`
9. `cigar-policy = 0.9.1-honey.1`
10. `cigar-store = 0.9.1-honey.1`
11. `cigar-effects = 0.9.1-honey.1`
12. `cigar-retrieval = 0.9.1-honey.1`
13. `cigar-space = 0.9.1-honey.1`
14. `cigar-catalog = 0.9.1-honey.1`
15. `cigar-code-intel = 0.9.1-honey.1`
16. `cigar-compiler = 0.9.1-honey.1`
17. `cigar-api = 0.9.1-honey.1`
18. `cigar-observe = 0.9.1-honey.1`
19. `cigar-daemon = 0.9.1-honey.1`
20. `cigar-sdk = 0.9.1-honey.1`
...
a clean project depending only on `cigar-sdk = 0.9.1-honey.1` from the local registry.
...
4. From a clean environment with no workspace patch or local registry replacement, compile and
   test `cigar-sdk = 0.9.1-honey.1` from crates.io on the supported platform matrix.
