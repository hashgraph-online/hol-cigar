...
Scoped at-least-once event pages use contiguous visibility-relative cursors, advisory leases carry
monotonic resource fencing tokens, focus branches retain checkpoint state across task switches and
offline resume, and project links are directional, disclosure-gated, and contribution-capped.
...
guards, and reject any inconsistent or duplicate-key state during restoration.
