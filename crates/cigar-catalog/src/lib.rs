...
pub use connector::{
    ...
    DiscoveryReason, DiscoveryRequest, IngestionReceipt, InvalidationBatch, InvalidationCause,
    InvalidationWorker, MAX_ATOMIZATION_BYTES, MAX_CONNECTOR_ITEMS, MAX_CONNECTOR_READ_BYTES,
    MAX_SECRET_PATTERNS, SourceChange, SourceConnector, SourceHealth, SourceHealthState,
