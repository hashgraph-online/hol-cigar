...
- Status: Future / non-selected for Honey 0.9.1
- Date: 2026-07-20
...
preview/execute/status operations. Honey 0.9.1 continues to support the granular v1 sequence and
...
Honey 0.9.1 keeps all granular v1 operations and their current semantics. Downstream clients retain
