...
Honey ships `cigar-rust-sdk-0.9.1-honey.1-local-registry.tar.gz`, a self-contained offline Cargo
...
tar -xzf cigar-rust-sdk-0.9.1-honey.1-local-registry.tar.gz -C "$HOME/.local/share/cigar-honey/rust-registry"
