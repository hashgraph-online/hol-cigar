...
<!-- docs-check: illustrative -->
```sh
python3 demos/run_honey.py --runtime-archive cigar-0.9.2-aarch64-apple-darwin.tar.gz --runtime-sha256 "$RUNTIME_SHA256" --scenario offline-context --output honey-offline-context.json
```
