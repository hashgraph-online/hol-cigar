...
EVIDENCE_SCHEMA_SHA256 = (
    "628071a20bd6019ff7209912a41d1ac32c89477252941d45642a81c639a72641"
)
...
def generate(root: Path) -> None:
    ...
    if manifest.get("version") != VERSION or manifest.get("context_abi") != CONTEXT_ABI:
        raise HoneyProfileError("product-version authority is not exact Honey v0.9.1")
