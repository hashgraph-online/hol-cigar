...
class PythonSdkArtifactBuilderTests(unittest.TestCase):
    ...
    def test_wheel_record_and_exact_inventory_reject_tampering(self) -> None:
        ...
        record = "hol_cigar-0.9.1.dev1.dist-info/RECORD"
