...
class StableReleaseTests(unittest.TestCase):
    ...
    def test_stable_archives_have_genuine_stable_identities(self):
        self.assertEqual(
            release.handoff.artifact_names("0.11.0"),
            {
                "cigar-context-0.11.0.crate",
                "hol-org-cigar-0.11.0.tgz",
                "hol_cigar-0.11.0.tar.gz",
                "hol_cigar-0.11.0-py3-none-macosx_11_0_arm64.whl",
            },
        )
        for version in ("0.10.2", "0.11.0-beta.1", "0.11.0+substitution", "../0.11.0"):
