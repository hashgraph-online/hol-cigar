...
EXPECTED_ARTIFACTS = [
    ("source", "cigar-0.9.1-honey.1-source.tar.gz"),
    ("docs", "cigar-0.9.1-honey.1-docs.tar.gz"),
    (
        "schemas-conformance",
        "cigar-0.9.1-honey.1-schemas-conformance.tar.gz",
    ),
    (
    ...
    ("claude-code-plugin", "cigar-claude-code-0.9.1-honey.1.tar.gz"),
    ("honey-demos", "cigar-honey-demos-0.9.1-honey.1.tar.gz"),
    ("release-notes", "RELEASE_NOTES_HONEY_v0.9.1.md"),
