...
#[serde(rename_all = "snake_case")]
pub enum Treatment {
    /// Exact published Honey reference implementation.
    Honey,
...
pub enum IntelligenceProfile {
    ...
    /// H2 requirement-aware ranking candidate with H1 packing held constant.
    #[serde(rename = "balanced.v2-candidate.2")]
    BalancedV2Candidate2,
    /// CIGAR 0.9.3 coverage-saturating production profile.
    #[serde(rename = "balanced.v3")]
    BalancedV3,
    /// CIGAR 0.9.4 risk-reserved value-of-information profile.
    #[serde(rename = "balanced.v4")]
    BalancedV4,
}
