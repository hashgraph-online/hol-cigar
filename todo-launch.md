...
- [ ] Implement deterministic per-target minimization into fresh outputs; enforce byte/count ceilings, preserve named regressions, and emit old-to-new digest maps. Never share a writable corpus between fuzzers.
